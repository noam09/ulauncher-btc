...
class BtcExtension(Extension):

    def __init__(self):
        super(BtcExtension, self).__init__()
...
class KeywordQueryEventListener(EventListener):
    ...
    def on_event(self, event, extension):
        ...
        urls = [
            ('Bitstamp', 'https://www.bitstamp.net/api/v2/ticker/btc{}'.format(symbol[0]), 'last'),
            ('Bitfinex', 'https://api.bitfinex.com/v1/pubticker/btc{}'.format(symbol[0]), 'last_price'),
            ('Coinbase', 'https://api.coinbase.com/v2/prices/spot?currency={}'.format(symbol[0].upper()), 'data', 'amount'),
            ('CEX', 'https://cex.io/api/last_price/BTC/{}'.format(symbol[0].upper()), 'lprice')
            ]
